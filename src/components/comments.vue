        ...
        <div :id="'comment-'+comment.coid">
          <div class="comment-view" onclick="">
            <div class="comment-header">
              <img class="avatar" :src="$utils.gravatarImg(comment.mail)+'?s=80&r=G&d=identicon'" :title="comment.author"
                   width="80" height="80">
            ...
            <li v-for="child in  comment.children" :id="'li-comment-'+child.coid"
              ...
              <div :id="'comment-'+ child.coid">
                <div class="comment-view">
                  <div class="comment-header">
                    <img class="avatar" :src="$utils.gravatarImg(child.mail)+'?s=80&r=G&d=identicon'" :title="child.author"
                         width="80"
                         height="80">
